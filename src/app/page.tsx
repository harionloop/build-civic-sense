  ...
  <footer className="w-full text-center py-8 glass-card rounded-t-3xl">
    <div className="flex flex-col items-center max-w-6xl mx-auto">
      <div className="flex space-x-6 mb-4">
        <a
          href="#"
          className="themed-link text-lg hover:text-purple-400 transition-colors duration-300"
        >
          Home
        </a>
        <a
      ...
      <div className="flex space-x-6 mb-4">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="themed-link text-lg hover:text-blue-500 transition-colors duration-300"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="themed-link text-lg hover:text-gray-400 transition-colors duration-300"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="themed-link text-lg hover:text-blue-400 transition-colors duration-300"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
